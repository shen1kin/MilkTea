...
@WebServlet("/milk-tea-attribute-value")  // URL 以 / 开头
public class MilkTeaAttributeValueServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // 调用 DAO 中的方法进行属性查询
            List<String> attribute_valueList = MilkTeaAttributeValueDao.getAttributeValuesByAttributeName(attribute);
            ...
            if (!attribute_valueList.isEmpty()) {
                ...
                attribute_valueJson.put("list", attribute_valueList);
